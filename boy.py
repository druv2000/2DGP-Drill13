...
class Boy:
    ...
    def draw(self):
        ...
        self.font.draw(int(self.sx - 100), int(self.sy + 60), f'({self.x:5.5f}, {self.y:5.5f})', (255, 255, 0))
        self.font.draw(int(self.sx), int(self.sy + 100), f'{self.ball_count}', (255, 255, 255))
